    ...
    public void onCardClick(int cardActionId, String cardTag) {
        if (cardActionId == ACTION_PICK_PLACE) {
            ...
            try {
                ...
                //intentBuilder.getLastLocation();
                Intent intent = intentBuilder.build(getActivity());
                // Start the Intent by requesting a result, identified by a request code.
                //intentBuilder.setLatLngBounds(new LatLngBounds(new LatLng(41.607642, 0.623307),new LatLng(41.607642, 0.623307)));
                            ...
                            .addOnSuccessListener(getActivity(), new OnSuccessListener<Location>() {
                                ...
                                public void onSuccess(Location location) {
                                    ...
                                    if (location != null) {
                                        ...
                                        intentBuilder.setLatLngBounds(new LatLngBounds(ll,ll));
                                    }
                                }
                            });
